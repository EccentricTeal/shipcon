...
const int GYRO_START[6] = {0x10, 0x02, 0x01, 0x01, 0x10, 0x03};
const int GYRO_REQ_STAT[8] = {0x10, 0x02, 0x10, 0x10, 0x10, 0x10, 0x10, 0x03};
const int GYRO_RESET[6] = {0x10, 0x02, 0x08, 0x08, 0x10, 0x03};
const int GYRO_OFFSET_CANCEL[6] = {0x10, 0x02, 0x80, 0x80, 0x10, 0x03};
